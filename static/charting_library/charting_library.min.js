!(function (t, e) {
    ...
    var e =
        Object.assign ||
        function (t) {
            for (var e, o = 1, i = arguments.length; o < i; o++) for (var n in (e = arguments[o])) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
            return t;
        };
    function o(t, i) {
        var n = e({}, t);
    ...
    var i = { mobile: { disabled_features: ["left_toolbar", "header_widget", "timeframes_toolbar", "edit_buttons_in_legend", "context_menus", "control_bar", "border_around_the_chart"], enabled_features: [] } },
        n = {
            width: 800,
            height: 500,
            interval: "D",
    ...
    var r = (function () {
        function t(t) {
            ...
            if (((this._options = o(n, t)), t.preset)) {
                var e = i[t.preset];
                e
                    ? (void 0 !== this._options.disabled_features ? (this._options.disabled_features = this._options.disabled_features.concat(e.disabled_features)) : (this._options.disabled_features = e.disabled_features),
                      void 0 !== this._options.enabled_features ? (this._options.enabled_features = this._options.enabled_features.concat(e.enabled_features)) : (this._options.enabled_features = e.enabled_features))
    ...
    (window.TradingView = window.TradingView || {}), (window.TradingView.version = s), (t.version = s), (t.widget = r), Object.defineProperty(t, "__esModule", { value: !0 });
});
